...
background_music = pygame.mixer.Sound("Runners_256k.mp3")
...
def iniciar_juego(usuario, dificultad):
   ...
   '''
   def modo_escape():
      respuesta = messagebox.askyesno('Tutorial', 'Movimientos: \nPara moverse debe utilizar la flechas del teclado (si tiene un teclado 60%, di... skill issues)\nPara colocar un trampa debe utilizar espcaio (Modo escape)\n¿Desea continuar?')
      if respuesta:
   ...
   '''
   def modo_cazador():
      respuesta = messagebox.askyesno('Tutorial', 'Movimientos: \n Para moverse debe utilizar la flechas del teclado (si tiene un teclado 60% te jodes)\Para colocar un trampa debe utilizar espcaio (Modo escape)\n¿Desea continuar?')
      if respuesta:
         mapa = Mapa(usuario, dificultad, 20, 40)
         mapa.crear_mapa()
