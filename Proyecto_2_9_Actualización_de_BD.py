...
import json
import os
#TODO: Mostrar top5, stamina visual, niveles de dificultad,
   ...
   def mover_jugador(self, px, py):
      ...
      if (ny, nx) == self.salida:
         if self.modo_actual == 'Escape':
            ...
            max_puntos_tiempo = 1500 #Si dura más de 150 no obtiene puntos por tiempo 150 = 2:30 minutos Why? :v
            ...
            #TODO: no le da la gana de guardar luego lo arreglo, okis
            data = cargar_usuarios()
            for u in data["usuarios"]:
