   ...
   def mover_jugador(self, px, py):
      ...
      if (ny, nx) == self.salida:
         if self.modo_actual == 'Escape':
            ...
            max_puntos_tiempo = 1500 #Si dura más de 150 no obtiene puntos por tiempo 150 = 2:30 minutos
